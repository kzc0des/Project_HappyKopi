        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalStockIn = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalSold = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalWastage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalAdjusted = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ClosingStock = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UnitOfMeasure = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyIngredientSummaries", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyIngredientSummaries_IngredientId",
