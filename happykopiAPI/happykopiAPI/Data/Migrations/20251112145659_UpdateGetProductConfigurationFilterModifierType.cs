...
{
    /// <inheritdoc />
    public partial class UpdateGetProductConfigurationFilterModifierType : Migration
    {
        /// <inheritdoc />
...
BEGIN  
    ...
    -- 4. Get ALL Available Addons (no Type filter)
    SELECT 
        M.Id,
        M.Name,
        M.Price,
...
END;
GO";
            migrationBuilder.Sql(rollbackSpSql);
        }
    }
}
