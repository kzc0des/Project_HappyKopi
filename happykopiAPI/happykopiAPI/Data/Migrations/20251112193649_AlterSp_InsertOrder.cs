...
{
    public partial class AlterSp_InsertOrder : Migration
    {
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT @OrderId AS OrderId, @OrderNumber AS OrderNumber, 'SUCCESS' AS Status, 'Order created successfully with inventory deducted' AS Message;
